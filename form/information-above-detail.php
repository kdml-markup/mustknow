      ...
      <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper detail-wrapper form">
           ...
           <div class="detail-view">
                ...
                <div class="title">
                    <em><strong>내용증명 &#183; </strong>부동산</em>
                    <h2>주택 전세계약해지 통보 및 전세보증금에 대한 반환 내용증명</h2>
                    <div class="info">
                        <ul>
                    ...
                    <div class="lt_section">
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="item active"><img src="/mustknow/dist/img/@temp_prove.jpg" alt="소프트웨어 사업 표준하도급 기본계약서"></div>
                                <div class="item"><img src="/mustknow/dist/img/@temp_prove.jpg" alt="소프트웨어 사업 표준하도급 기본계약서"></div>
                                <div class="item"><img src="/mustknow/dist/img/@temp_prove.jpg" alt="소프트웨어 사업 표준하도급 기본계약서"></div>
                            </div>
                        ...
                        <div class="section">
                           <div class="purchasing_info">
                            ...
                            <div class="description">
                                <h3>개요</h3>
                                <p>주택 전세계약해지 통보 및 전세보증금에 대한 반환 내용증명</p>
                                <h3>목차</h3>
                                <p class="scroll"><span>내용증명서의 발송목적은 증거보전의 필요와 상대방(채무자 등)에게 심리적 압박감을 주어 그 이행을 실현하게 하거나 어떠한 사실(계약 해제 등)을 정확하게 알리는 목적이 있다. 내용증명서의 발송목적은 증거보존 필요와 상대방(채무자등)에게 심리적 압박 감을 주어 그 이행을 실현하게 하거나 어떠한 사실(계약 해제 등)을 정확하게 알리는 목적이 있다.</span></p>
                            </div>
                        </div>
                    </div>
                </div>
