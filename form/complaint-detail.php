      ...
      <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper detail-wrapper form">
           ...
           <div class="detail-view">
                ...
                <div class="title">
                    <em><strong>매뉴얼 &#183; </strong>부동산</em>
                    <h2>임대주택 입주민 주거안전 지원 복지 매뉴얼</h2>
                    <div class="info">
                        <ul>
                    ...
                    <div class="lt_section">
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="item active"><img src="/mustknow/dist/img/@temp_manual.jpg" alt="매뉴얼"></div>
                                <div class="item"><img src="/mustknow/dist/img/@temp_manual.jpg" alt="매뉴얼"></div>
                                <div class="item"><img src="/mustknow/dist/img/@temp_manual.jpg" alt="매뉴얼"></div>
                            </div>
                        ...
                        <div class="section">
                           <div class="purchasing_info">
                            ...
                            <div class="description">
                                <h3>개요</h3>
                                <p>임대주택 입주민 주거안전 지원 복지 매뉴얼</p>
                                <h3>목차</h3>
                                <p class="scroll"><span>복지 매뉴얼은 LH와 보건복지부 등 중앙정부, 지자체 에서 시행중인 복지서비스 신청자격, 절차 등을 이해하기 쉽게 정리한 복지정보 종합안내서다.  복지 매뉴얼은 LH와 보건복지부 등 중앙정부, 지자체 에서 시행중인 복지서비스 신청 자격, 절차 등을 이해하기 쉽게 정리한 복지정보 종합안내서다.</span></p>
                            </div>
                        </div>
                    </div>
                </div>
