        ...
        <div class="content-wrapper">
           ...
           <div class="content main">
                <div class="sch_filter">
                	...
                	<div class="filter_area">
                		<div class="list-type _list-type">
                			<ul>
                				<li class="card on" style="margin-right: 8px;">
                					<a href="#"><em>썸네일형</em></a>
                				</li>
                				<li class="list">
                					<a href="#"><em>리스트형</em></a>
                ...
                <?php
                    ...
                    $array = array(
                        array(
                            "title"=>"디자인업종 디지털 디자인 분야 제정 표준하도급계약서",
                            "date"=>"2016-05-30",
                            "impt"=>"3",
                            "count"=>"20",
                ...
                <!--[D] card view -->
                <div role="main">
                    <ul class="tiles-wrap _tiles-wrap" style="display:block;">
                        <?                     
                        $count = 0;
                        while(++$count <= 16){ 
                            $i = rand(0,5);
                        ...
                        <li class="<? echo $type ?>" data-date="<? echo $array[$i]['date'] ?>" data-popularity="<? echo $array[$i]['impt'] ?>" data-issue="부동산">
                          ...
                          <p><a href="explanation-of-case-detail.php"><? echo mb_strimwidth($array[$i]['txt'],'0','120',"...","utf-8"); ?></a></p>
                          <b>999,000</b>
                          <button type="button" class="favorites btnDuo">즐겨찾기 추가</button>
                          <button type="button" class="download btnDuo on">다운로드</button>
                          <ol class="download_style">
                          	<li class="zip">
                      			<span></span>
                      			<em>zip</em>
                          	</li>
