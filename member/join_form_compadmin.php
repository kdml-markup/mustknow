  ...
  <body class="main hold-transition skin-blue sidebar-mini inside-land">
    ...
    <div class="wrapper">
      ...
      <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper cscenter_wrap signup_form writemail join_wrap action_wrap">
           ...
           <div class="content main">   
           		<div class="lt_section">
      		     	<h3>기업정보 입력</h3>             
           			<p>산업분류<em class="asterisk">*</em>
           				<span class="notice">선택하신 산업분류에 따라 다른 콘텐츠를 제공합니다.</span>
           			</p>
                    <div>
                    	<span id="select_category" class="select_result">산업분류를 선택해주세요.
           			...
           			<input class="c_outside" type="text" id="user_id" placeholder="기업명을 입력해주세요.">
           			<p>대표자명<em class="asterisk">*</em></p>
           			<input class="c_outside" type="text" id="user_id" placeholder="대표자명을 입력해주세요.">
           			<p>사업자 등록번호<em class="asterisk">*</em></p>
           			<input class="c_outside" type="text" id="user_id" placeholder=",'-'없이 사업자 등록번호를 입력해주세요.">
           			<p>대표 주소<em class="asterisk">*</em></p>
           			<input class="c_outside" type="text" id="user_id" placeholder="대표주소를 입력해주세요.">
                    ...
                    <div class="phone_num">
           			...
           			<input class="c_outside" type="text" id="user_id" placeholder="'-'없이 법인 등록번호를 입력해주세요.">
           			<p>팩스번호<em class="asterisk">*</em></p>
                    <div class="phone_num">
           		...
           		<div class="rt_section">
                    ...
                    <div class="phone_num">
                    	<span id="select_cellph" class="select_phone">010
                    		<span class="select_arrow"></span>
                    	</span>
                    	<ul id="ul_cellph" style="display:none; position:absolute; z-index:1000;">
                    		<li>
                    			<span>010</span>
                    		</li>
                    		<li>
    ...
    $('#select_cellph').click(function() {
        	
	       if($('#ul_cellph').css('display') == 'none'){
	       	  $('#ul_cellph').show();	
	       } else{
	       	  $('#ul_cellph').hide();
	       }
    ...
    $('#ul_cellph li').click(function() {
       	$("#select_cellph").get(0).innerHTML = ( $(this).children().get(0).innerHTML+ '<span class="select_arrow"></span>');
       	$("#select_cellph").css("color", "#4f555e");
       	$('#ul_cellph').hide();
    });
